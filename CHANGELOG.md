...
* 0.48.2 ([`efa495e`](https://github.com/crypkit/blockapi/commit/efa495e93b11493a2824bca3df99e2b62ffe4677))
...
* Update to v0.21.3 ([`f583ddc`](https://github.com/crypkit/blockapi/commit/f583ddc71487e59bde50452a90eee0057c6e0404))
...
* feat: add solana staked balance ([`828df57`](https://github.com/crypkit/blockapi/commit/828df576a1146faea273bf469dba7af7d49ffcbf))
...
* chore: Update pre-commit dependencies to current versions (#111) ([`c0efb21`](https://github.com/crypkit/blockapi/commit/c0efb2117ad62d3bfb96169a86030c8da237f31b))
...
* feat: snx revision ([`ee676a1`](https://github.com/crypkit/blockapi/commit/ee676a1e802b969a32ec1ee2083af5a1fb00667a))
...
* fix: fix snx optimism test ([`a24c5ac`](https://github.com/crypkit/blockapi/commit/a24c5ac3e9197f90064c7d0ea3ab65b48b46e933))
...
* fix: Skip unknown chains when fetching DeBank (#96) ([`a75afc5`](https://github.com/crypkit/blockapi/commit/a75afc50fb7ac14bacceb365192a11bbabd1e812))
...
* feat: Add Blockchair DOGE fetching (#68) ([`fd009ea`](https://github.com/crypkit/blockapi/commit/fd009ea193b8984b60edf32186455201abc3497b))
...
* fix(amberdata): fix get_balances ([`a100f7e`](https://github.com/crypkit/blockapi/commit/a100f7e054f5d3e46647ad5f44668c75c4d6e9af))
...
* feat(requirements): delete unused gevent package ([`2725dbb`](https://github.com/crypkit/blockapi/commit/2725dbbac4e6fc2950ee2885597a35abbf63b16a))
...
* fix(api): api_key argument added ([`ef9ecfa`](https://github.com/crypkit/blockapi/commit/ef9ecfa0f2a480268d38b6d3c88aeb37b1c30867))
...
feat: bump blockapi version to `0.1.11`. ([`fece427`](https://github.com/crypkit/blockapi/commit/fece4270e474e847653e9e55c2cb2fdd02248e0d))
...
* increase version ([`7254476`](https://github.com/crypkit/blockapi/commit/7254476dd7e65b5e7e3576cd72e73692db333339))
...
* version updated ([`3a73fd4`](https://github.com/crypkit/blockapi/commit/3a73fd4619eae63297a69ffb538a740484f5da04))
...
* erc20 tokens balance ([`00cabe7`](https://github.com/crypkit/blockapi/commit/00cabe798f05f67898e09271432fb2fb06987506))
...
* Tronscan API (TRX) added ([`4d475c4`](https://github.com/crypkit/blockapi/commit/4d475c43dcda5a6d8cb646ac197e3b6167cfd4aa))
...
* coinaddr import replaced by coinaddrng ([`c96d5bb`](https://github.com/crypkit/blockapi/commit/c96d5bbdb150058d4a3beb91541d958f9f16b443))

* Merge pull request #1 from galvanizze/master

add safe request for unstable tzscan endpoint ([`55321ca`](https://github.com/crypkit/blockapi/commit/55321cad33af02f5adf7be8cdb6980886c1c48de))

* add safe request for unstable tzscan endpoint ([`8c02641`](https://github.com/crypkit/blockapi/commit/8c026413585295b8d566f7a26e88dc0971e34a02))

* mercerweiss(ZEC),zchain(ZEC) - new APIs; etherscan - address validation ([`c40d753`](https://github.com/crypkit/blockapi/commit/c40d753df926e04135910e3024ce5c36880c3531))

* added Litecoin,Dash,Dogecoin,Zcash with ChainSoAPI; optional Cloudflare bypass in request; fixed paging in NeoscanAPI ([`667a71a`](https://github.com/crypkit/blockapi/commit/667a71abfa0f0b6b37102535cbeaa58dd515d761))

* address format check at API class constructor (not all APIs done yet), Neoscan API added - get_balance, get_txs ([`e09b5bb`](https://github.com/crypkit/blockapi/commit/e09b5bb1031137f89ead76897a7cdddf01ba3c74))

* functions to return list of working APIs for a single coin / for each coin at once ([`5894f8f`](https://github.com/crypkit/blockapi/commit/5894f8fcd090e18f88f2c6c9cd81442b43cb1827))

* added Makefile to automatize install/uninstall/dist ([`3883fd3`](https://github.com/crypkit/blockapi/commit/3883fd3cef46949737295bc96d1c64bbb196fba3))

* test.py rewritten to use pythonic unittest + slight change in the project structure ([`ebe05e2`](https://github.com/crypkit/blockapi/commit/ebe05e24ed51a1563dce9ca26d46901047d98b95))

* fixed import in test module, README has been written ([`f69222f`](https://github.com/crypkit/blockapi/commit/f69222f41759fb5890e4d58c9ff80575ed329d07))

* initial import, basic setup.py for pip package making ([`967a6b1`](https://github.com/crypkit/blockapi/commit/967a6b1d44eb48e4d6286bedf0581bfea30e8c80))

* Initial commit ([`4ca2620`](https://github.com/crypkit/blockapi/commit/4ca26209707248c62b5cfdc16f9c8eee9ff16572))
