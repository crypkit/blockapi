...
def test_create_protocol_from_api():
    ...
    assert protocol.logo_url == 'https://static.debank.com/image/project/logo_url/0xmons/' \
...
def test_balance_protocol_can_be_set():
    ...
    balance = BalanceItem.from_api(balance_raw="3", coin=COIN_ETH, raw={}, protocol=protocol)
